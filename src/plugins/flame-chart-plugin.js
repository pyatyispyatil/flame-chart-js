...
export default class FlameChartPlugin extends UIPlugin {
    ...
    reset(withYreset = true) {
        this.colors = {};
        this.lastRandomColor = DEFAULT_COLOR;
        this.positionY = withYreset? 0 : this.positionY;
    ...
    renderNodeStroke() {
        if (this.hoveredRegion && this.hoveredRegion.type === 'node'){
            ...
            this.renderEngine.renderNodeStrokeFromData({x,y,w,h:this.renderEngine.blockHeight,color:'#141932'}
            );
        }
    }
